...
import parseSitemapXml, {SitemapXml} from '@/utils/Sitemap';
...
export default async function SiteMap() {
  ...
  let sitemapData:SitemapXml[] = await parseSitemapXml();
    ...
    <>
      ...
      <section className='max-w-2xl px-8'>
        <div className='bg-transparent pb-10 grid grid-cols-1 gap-[1.5rem] md:grid-cols-2 relative z-10 rounded-lg w-full col-span-full'>
            {sitemapData && sitemapData.map((urlData:SitemapXml, index) => (
                <div key={index}>
